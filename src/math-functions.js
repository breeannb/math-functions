...
//         `The product of ${a} and ${b} and ${c} is ${secondProduct[0]}.`
//     ];
// }
...
//         sumofAllNums = sum(sumofAllNums, sumArr[i])[0]
//     }
...
//     return [
//         sumofAllNums, 
//         `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sumofAllNums} is their sum.`
//     ];
// }
...
//         productofAllNums = multiply(productofAllNums, multArr[i])[0]
//     }

    
//     // return [
//     //     productofAllNums, 
//     //     `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${productofAllNums} is their sum.`
//     // ];
    
//     return [
//         productofAllNums, 
//         `The numbers ${a},${b},${c} have a product of ${productofAllNums}.`
//     ];
// }
...
//         let productArr = multiply(product, dynamicArray[i]);
//         product = productArr[0];
//     }

//     return [
//         product, 
//         `The numbers ${dynamicArray} have a product of ${product}.`
//     ];
